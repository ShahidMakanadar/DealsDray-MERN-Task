            ...
            <div className='container'>
                <div class="row g-3 pt-5 mt-5">
                    ...
                    <div class="col-12  text-center">
                        <button type="submit" class="btn btn-success w-100" onClick={submitForm}>Register New User</button>
                    </div>
                    <div class="col-12  text-center">
                    <a type="button" href='http://localhost:3000/' class="btn btn-primary w-100" variant="outlined" >Login</a>
                    </div>
                </div>
            </div>
    )
